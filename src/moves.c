...
void queenMoves(const Piece_t *piece, const Pieces_t *board, Piece_t *moves, uint_fast16_t *mSize) {
    const int_fast8_t y = piece->position.y;
...
void beetleMoves(const Piece_t *piece, const Pieces_t *board, Piece_t *moves, uint_fast16_t *mSize) {
...
void grasshopperMoves(const Piece_t *piece, const Pieces_t *board, Piece_t *moves, uint_fast16_t *mSize) {
    const int_fast8_t y = piece->position.y;
...
void pillbugMoves(const Piece_t *piece, const Pieces_t *board,bool *visited, const Position_t *positions,
                  const Pieces_t last, Piece_t *moves, uint_fast16_t *mSize) {
    const Pieces_t id = piece->id;
...
void ladybugMoves(const Piece_t *piece, const Pieces_t *board, Piece_t *moves, uint_fast16_t *mSize) {
    const uint_fast16_t mStart = *mSize;
    ...
    for (int_fast8_t i = 0; i < 6; ++i) {
        ...
        for (int_fast8_t j = 0; j < 6; ++j) {
            ...
            for (int_fast8_t k = 0; k < 6; ++k) {
                ...
                for (uint_fast16_t h = mStart; h < *mSize; ++h) {
...
void spiderMoves(const Piece_t *piece, const Pieces_t *board, Piece_t *moves, uint_fast16_t *mSize) {
    const uint_fast16_t mStart = *mSize;
...
void antMoves(const Piece_t *piece, const Pieces_t *board, Piece_t *moves, uint_fast16_t *mSize, Hashmap_t *visited) {
    Hashmap_t hashmap;
...
void mosquitoMoves(const Piece_t *piece, const Pieces_t *board,bool *visited, const Position_t *positions,
                   const bool last, Piece_t *moves, uint_fast16_t *mSize) {
    const int_fast8_t z = piece->position.z;
...
void addMoves(const Context_t *context, Piece_t *moves, uint_fast16_t *mSize) {
    bool forceQueen = false;


    if ((context->turn == 7 && context->idToPos[W_QUEEN].z == -1) || (
            context->turn == 8 && context->idToPos[B_QUEEN].z == -1))
...
void getMoves(const Context_t *context, Piece_t **moves, uint_fast16_t *mSize) {
